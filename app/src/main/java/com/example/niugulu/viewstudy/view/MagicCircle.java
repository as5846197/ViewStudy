...
/**
 * Created by zhangcaoyang on 16/8/8.
 */
public class MagicCircle extends View {
    ...
    private float c;
    private float blackMagic = 0.551915024492f;
    ...
    private void model1(float interpolatedTime) {
        model0();

        p2.setX(radius+stretchDistance*interpolatedTime*5);
    }
