...
/**
 * Created by zhangcaoyang on 16/8/4.
 */
public class SeachView extends View {
    ...
    private void initAnimator() {
        ...
        mStartingAnimator.setInterpolator(timeInterpolator);
        mSearchingAnimator.setInterpolator(timeInterpolator);
        mEndingAnimator.setInterpolator(timeInterpolator);
